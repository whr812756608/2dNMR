...
class ComENet(nn.Module):
    ...
    def __init__(
        ...
        if self.pred == 'CH':
            self.lin_out = Projection(hidden_channels * 2, out_channels, out_hidden)
        else:
            self.lin_out = Projection(hidden_channels, out_channels, out_hidden)
...
#     model = ComENet(in_embed_size=3, out_channels=1, agg_method='sum', hidden_channels=256, out_hidden=[256, 1], pred='C')
    
#     for graph, nmr, filename in data_loader:
#         print(filename)
#         print(nmr.shape)
#         loss, out = model(graph, nmr)
#         print(nmr)
#         print(out)
#         print(nmr.shape, out.shape)
#         print(loss)
#         break
...
class SchNet(torch.nn.Module):
    ...
    """
    def __init__(self, energy_and_force: object = False, cutoff: object = 10.0, num_layers: object = 6, hidden_channels: object = 128, out_channels: object = 1,
                 num_filters: object = 128,
                 num_gaussians: object = 50,
                 in_embed_size: object = 560) -> object:
